...
namespace Algorithmia.Tests.UnitTests
{
    public class NoiseMapTests
    {
        ...
        {
            var noiseGenerator = NoiseGeneratorFactory.CreateNoiseGenerator(Enums.NoiseType.Perlin);
        ...
        public void GenerateNoiseMap_SameSeedProducesSameMap()
        {
            ...
            var noiseGenerator2 = NoiseGeneratorFactory.CreateNoiseGenerator(Enums.NoiseType.Perlin);
